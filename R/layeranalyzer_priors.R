...
#
# 'layer.prior' represents hyperparameters for the
# Bayesian analysis of the processes. There is a
# function for reading the prior definition from
# a csv file. An addition, a few default priors are
# also defined.
#
...
# Routine for reading prior from file:
